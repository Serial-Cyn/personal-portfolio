...
export default function TimeCapsule() {
  ...
  return (
    <>
      ...
      <div
        id="capsule"
        className="absolute bottom-0 w-4/5 sm:w-1/2 mb-8 py-2 flex justify-center items-center text-gray-400 border border-gray-400 rounded-full pointer-events-none"
      >
