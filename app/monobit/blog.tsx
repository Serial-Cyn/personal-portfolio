    ...
    <section className="px-6">
      <div>
        ...
        <div className="text-2xl text-justify mt-4 leading-normal">
          <p className="mb-4">
            ...
            fun way. This idea stemmed from the observation that many people
            struggle to grasp programming concepts through traditional learning
            methods.
          </p>
          <p>
            The development process began with extensive research on existing
            educational games and programming learning tools. I identified key
      ...
      <div>
        ...
        <div className="text-2xl text-justify mt-4 leading-normal">
          ...
          <p>
            These stages were repeated multiple times to ensure the final product was both
            enjoyable and educational. The culmination of this effort resulted
            in Monobit, a game that not only entertains but also empowers users
            to learn programming in a more interactive way.
          </p>
        </div>
      </div>
      <div>
        ...
        <div className="text-2xl text-justify mt-4 leading-normal">
          <p className="mb-4">
            Currently, Monobit is still a work in progress, with plans to expand its
            content and features. Future updates will include additional levels,
            more programming languages, and enhanced graphics and sound effects
            to further immerse players in the learning experience.
          </p>
          <p>
            I plan to develop Monobit into a Software as a Service (SaaS) platform,
            allowing users to be able to access the game from any device! This will 
            achieve my goal of making programming education more accessible and 
